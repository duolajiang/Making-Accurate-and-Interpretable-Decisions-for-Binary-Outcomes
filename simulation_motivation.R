...
colors <- c("model misspecification" = "blue", "function form include DGM" = "red", "correct specification" = "orange")
shapes <- c("model misspecification" = 0, "function form include DGM" = 1, "correct specification" = 2)
library(ggplot2)
p1 <- ggplot() +
  geom_point(aes(x=c(20,40,60,80,100,120,150,200,250,500),y=mse[,1],color="model misspecification",shape="model misspecification"),size=3)+
  geom_point(aes(x=c(20,40,60,80,100,120,150,200,250,500),y=mse[,2],color="function form include DGM",shape='function form include DGM'),size=3)+
  geom_point(aes(x=c(20,40,60,80,100,120,150,200,250,500),y=mse[,3],color="correct specification",shape='correct specification'),size=3)+
  geom_line(aes(x=c(20,40,60,80,100,120,150,200,250,500),y=mse[,1],color="model misspecification",shape='model misspecification'),size=0.8)+
  geom_line(aes(x=c(20,40,60,80,100,120,150,200,250,500),y=mse[,2],color="function form include DGM",shape='function form include DGM'),size=0.8)+
  geom_line(aes(x=c(20,40,60,80,100,120,150,200,250,500),y=mse[,3],color="correct specification",shape='correct specification'),size=0.8)+
...
colors <- c("f true DGM" = "black",
            "f1 flexible model" = "green",
            "f2 fitted to f1" = "blue",
            "f3 fitted to observed y" = "red")
